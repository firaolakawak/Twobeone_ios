  ...
  return (
    <LanguageProvider>
      ...
      <div className="app-mobile-shell min-h-screen bg-background flex flex-col">
        ...
        <header className="sticky top-0 left-0 right-0 z-50 flex items-center" style={{ minHeight: 'calc(4rem + var(--app-safe-area-top, env(safe-area-inset-top, 0px)))', paddingTop: 'var(--app-safe-area-top, env(safe-area-inset-top, 0px))', background: 'var(--card)', borderBottom: '1px solid var(--border)', boxShadow: '0 1px 0 0 var(--border)' }}>
